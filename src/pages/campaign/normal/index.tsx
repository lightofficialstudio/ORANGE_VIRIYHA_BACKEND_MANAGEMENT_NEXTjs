...
import { NormalCampaign } from 'types/viriyha_type/campaign';
...
function stableSort(array: NormalCampaign[], comparator: (a: NormalCampaign, b: NormalCampaign) => number) {
  const stabilizedThis = array.map((el: NormalCampaign, index: number) => [el, index]);
  stabilizedThis.sort((a, b) => {
    const order = comparator(a[0] as NormalCampaign, b[0] as NormalCampaign);
...
const OrderList = () => {
  ...
  const [rows, setRows] = React.useState<NormalCampaign[]>([]);
